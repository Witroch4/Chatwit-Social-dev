...
const SocialLogin = () => {
  ...
  return (
    <div className="flex w-full justify-center items-center p-2 space-x-2">
      ...
      {/* Facebook */}
      <LoginSocialButton provider="facebook" callbackUrl={callbackUrl}>
        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
          <title>Facebook</title>
          <path
            fill="#1877F2"
            d="M22 12.07C22 6.56 17.51 2 12 2S2 6.56 2 12.07c0 4.77 3.65 8.73 8.42 9.43v-6.68h-2.54v-2.75h2.54v-1.82c0-2.5 1.48-3.89 3.75-3.89c1.09 0 2.23.2 2.23.2v2.42h-1.25c-1.23 0-1.62.76-1.62 1.54v1.56h2.75l-.44 2.75h-2.31V21.5c4.77-.7 8.42-4.66 8.42-9.43"
          />
