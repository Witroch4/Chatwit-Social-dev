...
export default function DocumentViewer({ fileUrl, fileName, onClose, fileType = 'application/pdf' }: DocumentViewerProps) {
  ...
  return (
    <div className={`fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 ${fullscreen ? 'overscroll-none' : ''}`}>
      <div 
