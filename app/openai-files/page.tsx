...
export default function OpenAIFilesDemo() {
  ...
  const [processingPrompt, setProcessingPrompt] = useState<string>('Extract the main content and summarize this document');
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload files for processing with OpenAI's Assistants API
            </CardDescription>
          </CardHeader>
          <CardContent>
            <OpenAIFileUpload 
      ...
      {processResult && (
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>
              Content extracted from {selectedFile?.filename}
            </CardDescription>
          </CardHeader>
          <CardContent>
