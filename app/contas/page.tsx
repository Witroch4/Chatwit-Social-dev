    ...
    <div className="max-w-6xl mx-auto py-8 px-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Gerencie suas contas conectadas do Instagram
            </p>
          </div>
        </div>
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-medium">
                      {account.igUsername || "Usuário Instagram"}
                    </h3>
      ...
      <div className="mt-12 bg-muted p-6 rounded-lg">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Soluções inteligentes para automação de redes sociais
            </p>
          </div>
        </div>
        ...
        <div className="text-sm text-muted-foreground">
          <p>
            Conecte múltiplas contas do Instagram para gerenciar diferentes perfis e marcas em um único lugar.
            Cada conta conectada pode ter suas próprias automações, fluxos de mensagens e configurações.
          </p>
          <p className="mt-2">
            Precisa de ajuda? Entre em contato com nosso suporte através do e-mail <a href="mailto:suporte@witdev.com.br" className="text-primary hover:underline">suporte@witdev.com.br</a>
          </p>
        </div>
      </div>
    </div>
