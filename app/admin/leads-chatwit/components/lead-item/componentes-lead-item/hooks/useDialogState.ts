...
export function useDialogState() {
  ...
  return {
    ...
    isDigitando, setIsDigitando,
    showEspelhoSeletor, setShowEspelhoSeletor,
    showEspelhoDialog, setShowEspelhoDialog,
    confirmDeleteEspelho, setConfirmDeleteEspelho,
    selectedEspelhoImages, setSelectedEspelhoImages,
    isEnviandoEspelho, setIsEnviandoEspelho,
    isUploadingEspelho, setIsUploadingEspelho,
    showEspelhoUploadDialog, setShowEspelhoUploadDialog,
    showAnaliseDialog, setShowAnaliseDialog,
    showAnalisePreviewDrawer, setShowAnalisePreviewDrawer,
    showAnaliseValidadaDialog, setShowAnaliseValidadaDialog,
    ...
    confirmDeleteAllFiles, setConfirmDeleteAllFiles,
    isSaving, setIsSaving,
    isDownloading, setIsDownloading,
    isLoadingImages, setIsLoadingImages,
    isDeletedFile, setIsDeletedFile,
