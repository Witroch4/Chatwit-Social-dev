...
export function BibliotecaEspelhosDrawer({
  ...
  const handleEnviarParaSistemaExterno = async (espelhoId: string, imageUrls: string[], isBibliotecaContext = false) => {
    try {
  ...
  return (
    <>
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-2">
                                ...
                                <Badge variant="secondary">
                                  {espelho.totalUsos} uso(s)
                                </Badge>
                                {selectedEspelhoId === espelho.id && (
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <Switch
                                  ...
                                  onCheckedChange={(checked) => 
                                    handleToggleEspelho(espelho.id, checked)
                                  }
                                />
                              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="bg-card border rounded-lg p-4">
                        ...
                        <p className="text-2xl font-bold text-green-600">
                          {espelhos.filter(e => e.isAtivo).length}
                        </p>
                      </div>
      ...
      <Dialog open={showConfirmExternalDialog} onOpenChange={setShowConfirmExternalDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Deseja enviar as imagens do espelho "{pendingEspelhoData?.espelhoId ? 
      ...
      <EspelhoDialog
        ...
        imagensEspelho={
          editingEspelho?.espelhoCorrecao 
            ? JSON.parse(editingEspelho.espelhoCorrecao) 
            : []
        }
