...
async function selectMidiaForSending(agendamentoId) {
    try {
        ...
        if (agendamento.TratarComoPostagensIndividuais) {
            ...
            console.log(`[AgendamentoService] Selecionada mídia aleatória ${selectedMidia === null || selectedMidia === void 0 ? void 0 : selectedMidia.id} (sem incrementar contador)`);
        }
        else {
            ...
            console.log(`[AgendamentoService] Selecionada primeira mídia ${selectedMidia === null || selectedMidia === void 0 ? void 0 : selectedMidia.id} (sem randomização)`);
        }
        console.log("[AgendamentoService] Mídia selecionada:", selectedMidia === null || selectedMidia === void 0 ? void 0 : selectedMidia.id);
    ...
    try {
        ...
        if (agendamento.TratarComoPostagensIndividuais) {
            ...
            console.log(`[AgendamentoService] Webhook preparado para agendamento ${agendamentoId} (carrossel):`, {
                id: webhookData.id,
                totalMidias: ((_a = webhookData.midias) === null || _a === void 0 ? void 0 : _a.length) || 0,
                stories: webhookData.stories,
                reels: webhookData.reels,
                postNormal: webhookData.postNormal,
            });
