...
function isImage(url) {
    ...
    try {
        ...
        const extension = ((_a = pathname.split('.').pop()) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || '';
...
async function convertOfficeToPdf(officeUrl) {
    ...
    try {
        ...
        try {
            ...
            const pathname = urlObj.pathname;
            const fileExtension = (_a = pathname.split('.').pop()) === null || _a === void 0 ? void 0 : _a.toLowerCase();
