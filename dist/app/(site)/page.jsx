				...
				<div className="absolute z-0 inset-0 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,#086_100%)] dark:[background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#086_100%)]">
					<section className="z-auto">
						<div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
							<a href="https://github.com/devdeck101/authjs-prisma-template" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" target="_blank" rel="noreferrer">
								...
								<svg className="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Logo">
							...
							<div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
								<a href="https://www.youtube.com/playlist?list=PLR8OzKI52ppUa7VP0D671haaiQAkIww3W" className="inline-flex justify-center items-center py-3 px-5 text-primary  font-medium text-center  rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900" target="_blank" rel="noreferrer">
									Saiba mais
									<svg className="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Saiba mais">
										<path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"/>
									</svg>
								</a>
								<a href="https://youtu.be/3GlLKGmLYL8" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800" target="_blank" rel="noreferrer">
									<svg className="mr-2 -ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Video de demonstração">
							...
							<div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
								...
								<div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
									<a href="https://www.youtube.com/channel/UCj75B_51OXb9qH15wiHs-Hw/join" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400" target="_blank" rel="noreferrer">
										<svg className="h-8" viewBox="0 0 132 29" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Youtube">
									...
									<a href="https://livepix.gg/brkilian" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400" target="_blank" rel="noreferrer">
										<div className="flex items-center space-x-2 text-4xl">
											<lucide_react_1.HandCoins className="w-8 h-8 rounded-md dark:text-white/70"/>
											<span>Livepix</span>
										</div>
									</a>
									<a href="twitch.tv/developerdeck101" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
										<div className="flex items-center space-x-2 text-4xl">
											<lucide_react_1.Video className="w-8 h-8 rounded-md dark:text-white/70"/>
											<span>Twitch</span>
										</div>
									</a>
								</div>
