...
const login_social_button_1 = __importDefault(require("./login-social-button"));
const SocialLogin = () => {
    const callbackUrl = `${process.env.NEXT_PUBLIC_URL}`;
    console.log(callbackUrl);
    return (<div className="flex w-full justify-center items-center p-2 space-x-2">
      {/* Google */}
      <login_social_button_1.default provider="google" callbackUrl={callbackUrl}>
      ...
      </login_social_button_1.default>

      {/* Github */}
      <login_social_button_1.default provider="github" callbackUrl={callbackUrl}>
      ...
      {/* Facebook */}
      <login_social_button_1.default provider="facebook" callbackUrl={callbackUrl}>
        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
          <title>Facebook</title>
          <path fill="#1877F2" d="M22 12.07C22 6.56 17.51 2 12 2S2 6.56 2 12.07c0 4.77 3.65 8.73 8.42 9.43v-6.68h-2.54v-2.75h2.54v-1.82c0-2.5 1.48-3.89 3.75-3.89c1.09 0 2.23.2 2.23.2v2.42h-1.25c-1.23 0-1.62.76-1.62 1.54v1.56h2.75l-.44 2.75h-2.31V21.5c4.77-.7 8.42-4.66 8.42-9.43"/>
          <path fill="#FFF" d="m15.26 14.82l.44-2.75h-2.75v-1.56c0-.78.4-1.54 1.62-1.54h1.25V6.55s-1.14-.2-2.23-.2c-2.27 0-3.75 1.39-3.75 3.89v1.82h-2.54v2.75h2.54v6.68c.84.14 1.7.21 2.58.21c.88 0 1.74-.07 2.58-.21v-6.68h2.31"/>
        </svg>
      </login_social_button_1.default>
