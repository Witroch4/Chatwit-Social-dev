...
const DrawerContent = React.forwardRef((_a, ref) => {
    ...
    return (<DrawerPortal>
    <DrawerOverlay />
    <vaul_1.Drawer.Content ref={ref} className={(0, utils_1.cn)("fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border", "bg-white dark:bg-[#0C0A09] text-black dark:text-white", // Define fundo com cor específica no tema dark
        className)} {...props}>
...
DrawerContent.displayName = vaul_1.Drawer.Content.displayName;
const DrawerHeader = (_a) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<div className={(0, utils_1.cn)("grid gap-1.5 p-4 text-center sm:text-left border-b border-gray-200 dark:border-gray-700", className)} {...props}/>);
};
exports.DrawerHeader = DrawerHeader;
DrawerHeader.displayName = "DrawerHeader";
const DrawerFooter = (_a) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<div className={(0, utils_1.cn)("mt-auto flex flex-col gap-2 p-4 border-t border-gray-200 dark:border-gray-700", className)} {...props}/>);
};
