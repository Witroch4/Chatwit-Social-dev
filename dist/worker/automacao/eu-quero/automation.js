...
async function handleCommentChange(value, igUserId) {
    try {
        ...
        const mediaId = media === null || media === void 0 ? void 0 : media.id;
        const originalMediaId = media === null || media === void 0 ? void 0 : media.original_media_id;
        ...
        function matches(automacao) {
            ...
            if (!automacao.anyword) {
                const kw = ((_a = automacao.palavrasChave) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || "";
...
async function handleMessageEvent(msgEvt, igUserId) {
    ...
    try {
        if ((_a = msgEvt.message) === null || _a === void 0 ? void 0 : _a.is_echo) {
            console.log("[handleMessageEvent] Ignorando echo");
            return;
        }
        const senderId = (_b = msgEvt.sender) === null || _b === void 0 ? void 0 : _b.id;
        if (!senderId || senderId === igUserId)
            return;
        const accessToken = await (0, instagram_auth_1.getInstagramUserToken)(igUserId);
        if (!accessToken)
            return;
        const postbackPayload = ((_c = msgEvt.postback) === null || _c === void 0 ? void 0 : _c.payload) || ((_e = (_d = msgEvt.message) === null || _d === void 0 ? void 0 : _d.quick_reply) === null || _e === void 0 ? void 0 : _e.payload);
        if (postbackPayload) {
        ...
        const text = ((_f = msgEvt.message) === null || _f === void 0 ? void 0 : _f.text) || "";
        if (!text)
            return;
